...
<html>
	...
	<body>
        ...
        <div class="container el-feature">
            <dl>
            <dt>总投资人数：${indexTotalData.totalBids}人</dt>
        </dl>
            <dl>
                <dt>总借款人数:${indexTotalData.totalBidRequest}人</dt>
            </dl>
            <dl>
                <dt>总借款金额:${indexTotalData.totalRequestAmount}元</dt>
            </dl>
			<dl>
                <dt>已经赚取总利息:${indexTotalData.totalRewardInterest}元</dt>
            </dl>
            <dl>
                <dt>总待收本息</dt>
            </dl>
		...
		<div class="container el-panel">
			...
			<div class="panel el-panel">
				...
				<table class="table el-table table-hover">
					...
					<tbody>
						<#if publishPendngBidRequests.listData?size &gt; 0 >
							<#list publishPendngBidRequests.listData as data>
								<tr>
			...
			<div class="panel el-panel">
				...
				<table class="table el-table table-hover">
					...
					<tbody>
						<#if bidRequests.listData?size &gt; 0 >
							<#list bidRequests.listData as data>
								<tr>
									<td>${data.createUser.username }</td>
									<td>${data.title}</td>
									<td class="text-info">
