			...
			$(function(){
				...
				$("#bidBtn").on("click",function(){
					...
					$.post("/borrow_bid.do",{
						...
						if(data.success){
							$.messager.confirm("提示","恭喜你,投标成功",function () {
								location.reload();
                            });
						}else{
		...
		<div class="container" style="margin-top: 10px;">
			...
			<div class="row">
				...
				<div class="col-sm-3">
					<table style="height:110px;width:230px;">
						...
						<tr>
							...
							<div style="margin-bottom: 10px;" class="progress">
								<div style="width: ${bidRequest.persent}%" class="progress-bar progress-bar-info progress-bar-striped">
									${bidRequest.persent}%
								</div>
							</div>
							</td>
					...
					<#if bidRequest.bidRequestState==2>
						<#if self??>
							<br />
