			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="editForm" class="form-horizontal" method="post"
						...
						<input type="hidden" id="auditState" name="state" value="" />
						<div class="form-group">
							<label class="col-sm-2 control-label">用户</label>
							<div class="col-sm-6">
								<div class="dropdown" id="autocomplate">
									<input type="text" class="form-control" id="username"
										autocomplete="off" /> <input type="hidden" name="username" id="username"/>
								</div>
							</div>
						</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="dropdown" id="autocomplate">
                                    <label class="form-control" id="orderTime"
                                           autocomplete="off" /> <input type="hidden" name="orderTime" id="orderTime"/>
                                </div>
                            </div>
                        </div>
